...
def load_data_splits() -> Dict:
    ...
    train_df, valid_df = stratified_scaffold_split(df, smiles_col, label_col, CONFIG["TEST_SIZE"], CONFIG["RANDOM_STATE"])
    ...
    return {"train_df": train_df, "valid_df": valid_df, "y_train": y_train, "y_valid": y_valid, "smiles_col": smiles_col}
